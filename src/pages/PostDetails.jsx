  ...
  return (
    <div>
      {isLoading ? (
        ...
        <div>
          <Pagetitle> {Post.data.title} || HouseHunter</Pagetitle>
            ...
            <div className="banner rounded-sm overflow-hidden">
              ...
              <div className="infos bg-base-300  gap-5 flex flex-wrap justify-between items-center py-2 px-4">
                ...
                <div className="views font-semibold">
                  ...
                  {Post.data.views.length > 9
                    ? " " + Post.data.views.length
                    : " 0" + Post.data.views.length}
                </div>
                <div className="views font-semibold">
                  <i className="fa-solid fa-comment"></i> Comments:
                  {Post.data.comments > 9
                    ? " " + Post.data.comments
                    : " 0" + Post.data.comments}
                </div>
              </div>
            </div>
            <div className="mt-5">
