...
export default function Notfound() {
  ...
  return (
    <>
      <Pagetitle>{statusText} - HouseHunter</Pagetitle>
      <div className=" min-h-screen bg-sky-100 mx-auto flex h-[90vh] text-center flex-col justify-center items-center ">
        ...
        <div className="-translate-y-10">
          ...
          >
            <button className="btn bg-sky-500    btn-lg text-white hover:bg-sky-500    mt-5">
