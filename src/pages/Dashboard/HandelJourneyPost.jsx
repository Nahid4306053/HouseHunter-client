...
export default function HandelJourneyPost() {
  ...
  const [uploadedImg, SetImg] = useState(
    "https://i.ibb.co/TvmQZ3G/placeholder.png"
  );
  ...
  return (
    <>
      <Pagetitle>Handel Posts || HouseHunter</Pagetitle>
        ...
        <div className=" gap-5 mt-5">
          ...
          <div className="form-control col-span-2">
            <label className="label">
              <span className=" mt-5 label-text text-lg font-bold">
                Description
              </span>
            </label>
            ...
            <textarea
              required
              rows={5}
              className="textarea placeholder:text-black bg-transparent text-lg textarea-bordered border-black"
              name="description"
              placeholder="Share Your Journey Story With Our Car"
            ></textarea>

            <button className="btn bg-sky-500   text-white hover:bg-sky-500   mt-10">
              Publish now
            </button>
          </div>
        </div>
