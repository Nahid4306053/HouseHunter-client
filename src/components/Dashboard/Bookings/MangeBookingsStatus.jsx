...
export default function MangeBookingsStatus({ id }) {
  ...
  return (
    <>
      <button
        onClick={() => handelStatus("Confirmed")}
        data-tip="Confirme Booking"
        className="btn text-success tooltip capitalize btn-ghost btn-xs text-lg "
      >
        <i className="fa-solid fa-circle-check"></i>
      </button>

      <button
        onClick={() => handelStatus("Cancelled")}
        data-tip="Cancel Booking"
        className="btn text-sky-500   tooltip capitalize btn-ghost btn-xs text-lg "
      >
