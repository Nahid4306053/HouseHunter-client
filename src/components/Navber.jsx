...
export default function Navber() {
  ...
  const links = (
    <>
      ...
      <li>
        <NavLink to="/house">Our Houses</NavLink>
      </li>
  ...
  return (
    <header
      style={{
        background: `${
          opentSticky ? "linear-gradient(#000000 , #0000007e)" : "none"
        }`,
      }}
      className={`${Darkmood ? "" : " light"} ${
        opentSticky && " shadow-lg  "
      } fixed    w-full z-[100]`}
    >
      <div className="drawer ">
        ...
        <div className="drawer-side lg:hidden">
          ...
          <ul className="menu text-xl bg-sky-200 relative font-bold text-center   p-4 w-80 min-h-full ">
