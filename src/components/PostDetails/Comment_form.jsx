...
export default function Comment_form({ post_id }) {
  ...
  return (
    <form
      ...
      className="p-0 mt-24 w-full  comment-2"
    >
      <div className="col-12">
        <textarea
          ...
          required
          name="comment"
          className="textarea textarea-bordered form-control  w-full border-black placeholder:text-black text-lg rounded-none"
      ...
      <div className="mt-5 flex justify-end p-0">
        <button
          type="submit"
          className="btn bg-sky-500   hover:bg-sky-500   text-white rounded-none  mt-1 py-3 px-5"
        >
          Post Comment
        </button>
      </div>
